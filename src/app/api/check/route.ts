    ...
    try {
        ...
        for (const apiKey of apiKeys) {
            try {
                ...
                } else if (type === 'generate_phonetics') {
                    prompt = `Сен қазақ тілінің білікті маманысың. Мына сөздерге толық фонетикалық талдау жаса: ${question}.
            Әр сөз үшін мына үлгіні қатаң сақта:
            1. Буынға бөл және буын түрлерін (ашық, тұйық, бітеу) жаз.
            2. Әр әріпті жеке жазып, оған мінездеме бер (дауысты: жуан/жіңішке, ашық/қысаң, езулік/еріндік. дауыссыз: қатаң, ұяң, үнді).
            3. Егер 'и', 'у', 'я', 'ю' әріптері кездессе, олардың қандай дыбыстардан құралғанын (мысалы: и = ы+й) міндетті түрде көрсет.
            4. Соңында әріп пен дыбыс санын жаз.`;
                } else {
                    prompt = `
